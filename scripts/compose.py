...
**書いてよい過去の事実は、今日の話題を理解するために要るものだけ。**

とくに、**既に解決した不具合・お詫び・トラブル・炎上は書かない。**
今日の話題がその不具合そのものでない限り、持ち出す理由が無い。
読者にとっては蒸し返しでしかなく、読んで嫌な気分になる(編集規程5)。

(実測: 8月30日のリリースイベントの記事に、7月1日付の応募券の印刷不備に関する
お詫びを1段落ぶん書いていた。イベントの理解にはまったく要らない)

**分量が足りないことは、過去を持ち込む理由にならない。**事実が2〜3文しかない話題は、
そのまま短い記事にする(規程9)。水増しより短いほうがよい。
